...
1,6 km Schwimmen (Massenstart) / 36 km Radfahren / 10 km Laufen\
...
(time2finish). Ein eigenes Chipband wird nicht benötigt. In die Wertung
...
wird in der Wechselzone weitergegeben. Staffeln erhalten nur einen
Transponder.
...
der Onlineanmeldung kostenfrei möglich. Eine Abmeldung ist nur per
Mail an anmeldung@heidelbergman.de möglich.\
Eine Abmeldung nach Anmeldeschluss (14.07.2024) ist nicht möglich, auch
wenn die 7 Tage Rückgabefrist noch nicht abgelaufen sind.\
...
Verschiebung des Startplatzes aus gesundheitlichen Gründen ausschließlich aufs
Folgejahr.\
...
Laufen: 80 Minuten
Zielschluss: 240 Minuten (4 Stunden) nach Start
...
**DTU Sportordnung:**\
Der Heidelberg-Triathlon unterliegt in seinem Reglement der Sportordnung der
...
Es wird erstmals eine Bergwertung geben. Das Segment beginnt am Klingentor und endet mit Beginn der Johannes-Hoops-Wegs.\
Die Tagesschnellste und der Tagesschnellste werden geehrt.

**Preisgelder**\
Es werden Preisgelder ausgeschüttet. Sie werden jeweils an die ersten drei Athletinnen und Athleten gezahlt.
...
**Hinweise**\
Es gibt in diesem Jahr erstmals Umkleideräume und Duschmöglichkeiten vor Ort. Diese befinden sich in den Räumlichkeiten des Heidelberger Ruderklubs 1872 e.V., ca. 200m fußläufig vom Zielbereich.\
